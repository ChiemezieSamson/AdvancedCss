export const HomeData = [
  {
    ...
    "author": {
      "name": "Jane Doe",
      "bio": "Jane Doe is an economic analyst with over 15 years of experience covering global financial markets and policy decisions.",
    },
    "comments": [
      {
        "username": "EconExpert",
        "comment": "It's critical for G7 leaders to take into account the long-term impacts of their decisions on emerging markets.",
        "date": "2024-06-02",
      },
      {
        "username": "GlobalCitizen",
        "comment": "Hopefully, this leads to more substantial aid packages for developing countries still struggling to recover.",
        "date": "2024-06-02",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "John Smith",
      "bio": "John Smith is an environmental scientist and journalist, specializing in climate change and sustainability.",
    },
    "comments": [
      {
        "username": "EcoWarrior",
        "comment": "It’s alarming how little progress has been made despite constant warnings from the scientific community.",
        "date": "2024-06-06",
      },
      {
        "username": "ClimateRealist",
        "comment": "Immediate action is needed, but will governments ever fully commit to the cause?",
        "date": "2024-06-06",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Sarah Ali",
      "bio": "Sarah Ali is a political journalist with a focus on Middle Eastern geopolitics and conflict resolution.",
    },
    "comments": [
      {
        "username": "PeaceAdvocate",
        "comment": "This is a huge step toward stability in a region that has suffered for too long.",
        "date": "2024-06-09",
      },
      {
        "username": "SkepticWatcher",
        "comment": "Let’s hope this agreement holds. We’ve seen peace deals fall apart too many times before.",
        "date": "2024-06-09",
      },
    ],
  },
  {
    ...
    "author": {
      ...
      "bio": "Dr. Emily Thompson is a leading researcher in oncology with over 20 years of experience in medical innovations.",
    },
    "comments": [
      {
        "username": "HealthHopeful",
        "comment": "This is amazing news. Every step forward gives more hope to patients and their families.",
        "date": "2024-06-11",
      },
      {
        "username": "CancerSurvivor",
        "comment": "Having survived cancer myself, it's incredible to see the advances being made. We need more breakthroughs like this.",
        "date": "2024-06-11",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Alex Johnson",
      "bio": "Alex Johnson is a technology journalist and AI expert, writing on the impact of digital transformation on society.",
    },
    "comments": [
      {
        "username": "TechEnthusiast",
        "comment": "AI is evolving so fast, it's exciting but also a bit scary. Regulation is definitely needed.",
        "date": "2024-06-13",
      },
      {
        "username": "FutureCoder",
        "comment": "Can’t wait to see how AI reshapes industries. Hopefully, it’ll create more jobs than it replaces.",
        "date": "2024-06-13",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "David Lee",
      "bio": "David Lee is an environmental journalist focusing on natural disasters and the impacts of climate change.",
    },
    "comments": [
      {
        "username": "WildlifeProtector",
        "comment": "The damage to wildlife is heartbreaking. We need stronger action on climate change.",
        "date": "2024-06-16",
      },
      {
        "username": "ConcernedCitizen",
        "comment": "It’s devastating to see this happening again. The government needs to invest more in fire prevention and mitigation.",
        "date": "2024-06-16",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Michael Carter",
      "bio": "Michael Carter is a financial analyst and journalist with a focus on global markets and economic trends.",
    },
    "comments": [
      {
        "username": "MarketWatch",
        "comment": "Volatility is normal in times like this, but it’s still unsettling to see markets swing so much.",
        "date": "2024-06-19",
      },
      {
        "username": "InvestorPro",
        "comment": "Diversification is key. No one can predict what will happen in these unpredictable times.",
        "date": "2024-06-19",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Dr. Laura Rivera",
      "bio": "Dr. Laura Rivera is a biologist and conservation expert specializing in tropical ecosystems and biodiversity research.",
    },
    "comments": [
      {
        "username": "NatureLover",
        "comment": "It’s incredible to see new species still being discovered in such a well-explored area!",
        "date": "2024-06-21",
      },
      {
        "username": "ForestGuardian",
        "comment": "This highlights the importance of protecting the Amazon. Every species we save is a victory for our planet.",
        "date": "2024-06-21",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Sophie Martin",
      "bio": "Sophie Martin is a sports journalist covering international sporting events, including the Olympics and World Cup.",
    },
    "comments": [
      {
        "username": "SportsFanatic",
        "comment": "Can’t wait for the games to start! Paris is going to be an amazing host city.",
        "date": "2024-06-23",
      },
      {
        "username": "EcoAthlete",
        "comment": "Great to see the focus on sustainability. Events like this need to be more environmentally conscious.",
        "date": "2024-06-23",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Isabella Green",
      "bio": "Isabella Green is an environmental journalist with a focus on pollution, sustainability, and conservation efforts.",
    },
    "comments": [
      {
        "username": "EcoWarrior",
        "comment": "We all need to do our part in reducing plastic waste, but it’s great to see governments stepping in too.",
        "date": "2024-06-26",
      },
      {
        "username": "GreenInnovator",
        "comment": "The push for biodegradable plastics is promising. We need more corporate responsibility in this fight.",
        "date": "2024-06-26",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "David Chen",
      "bio": "David Chen is a cybersecurity expert and journalist, covering global cyber threats and the evolving landscape of digital security.",
    },
    "comments": [
      {
        "username": "TechGeek",
        "comment": "Cybersecurity needs to be a top priority, especially with attacks like this becoming more common.",
        "date": "2024-06-29",
      },
      {
        "username": "DataGuard",
        "comment": "It’s scary how vulnerable companies still are. More investment in security is essential.",
        "date": "2024-06-29",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "James Anderson",
      "bio": "James Anderson is a political analyst specializing in global security and diplomatic relations.",
    },
    "comments": [
      {
        "username": "GlobalObserver",
        "comment": "Cooperation is key. We need more unified efforts to tackle global security issues.",
        "date": "2024-07-01",
      },
      {
        "username": "DiplomatTalk",
        "comment": "Diplomacy should always be the first choice in resolving conflicts. Glad to see it emphasized here.",
        "date": "2024-07-01",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Linda White",
      "bio": "Linda White is a science and technology writer with a focus on renewable energy and environmental sustainability.",
    },
    "comments": [
      {
        "username": "GreenEnergyFan",
        "comment": "Renewable energy is the future. It’s great to see more investments in this space.",
        "date": "2024-07-03",
      },
      {
        "username": "ClimateOptimist",
        "comment": "Every advancement brings us closer to a sustainable future. We need to keep pushing for more innovation.",
        "date": "2024-07-03",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Mark Spencer",
      "bio": "Mark Spencer is a geopolitical analyst and writer focusing on international conflicts and economic sanctions.",
    },
    "comments": [
      {
        "username": "PeaceSeeker",
        "comment": "Sanctions are a double-edged sword. They can cripple a regime, but often hurt ordinary citizens too.",
        "date": "2024-07-06",
      },
      {
        "username": "ConflictWatcher",
        "comment": "Hopefully, this leads to negotiations and not a prolonged crisis. Diplomacy must prevail.",
        "date": "2024-07-06",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Dr. Alice Cheng",
      "bio": "Dr. Alice Cheng is a quantum physicist and professor, leading research on the practical applications of quantum computing.",
    },
    "comments": [
      {
        "username": "QuantumDreamer",
        "comment": "The potential here is mind-blowing. Quantum computing could change everything!",
        "date": "2024-07-09",
      },
      {
        "username": "TechFuturist",
        "comment": "Exciting times ahead. This could be the beginning of a new era in technology.",
        "date": "2024-07-09",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Amina Yusuf",
      "bio": "Amina Yusuf is a journalist covering renewable energy and environmental policies in developing nations.",
    },
    "comments": [
      {
        "username": "SolarEnthusiast",
        "comment": "It’s great to see solar power making a difference in communities that need it most.",
        "date": "2024-06-08",
      },
      {
        "username": "EcoInvestor",
        "comment": "Renewable energy investments in developing countries are key to tackling global climate change.",
        "date": "2024-06-08",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Jake Harris",
      "bio": "Jake Harris is a technology correspondent reporting on the latest trends and innovations in the tech industry.",
    },
    "comments": [
      {
        "username": "FutureTechFan",
        "comment": "The future of AI and robotics is here! So much potential to revolutionize daily life.",
        "date": "2024-06-09",
      },
      {
        "username": "EthicalCoder",
        "comment": "With all this advancement, we need to be careful about the ethical implications, especially in AI.",
        "date": "2024-06-09",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Rachel Kim",
      "bio": "Rachel Kim is a food security expert and journalist focusing on the intersection of agriculture, climate change, and economics.",
    },
    "comments": [
      {
        "username": "FarmerJoe",
        "comment": "We need more support for farmers who are on the front lines of climate change.",
        "date": "2024-06-10",
      },
      {
        "username": "EcoAdvocate",
        "comment": "The global food crisis is a wake-up call. Climate action and sustainable farming practices are more important than ever.",
        "date": "2024-06-10",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Olivia Harris",
      "bio": "Olivia Harris is a space technology journalist and editor, specializing in aerospace innovations and space exploration.",
    },
    "comments": [
      {
        "username": "RocketFan",
        "comment": "Reusability is the future of space travel. Great job, SpaceX!",
        "date": "2024-06-11",
      },
      {
        "username": "SpaceExplorer",
        "comment": "Each successful launch gets us closer to making space travel a regular occurrence. Exciting times ahead!",
        "date": "2024-06-11",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Tom Walker",
      "bio": "Tom Walker is a global trade and economics journalist, specializing in supply chain disruptions and international commerce.",
    },
    "comments": [
      {
        "username": "GlobalTrader",
        "comment": "Supply chain disruptions have ripple effects that hit every part of the economy. Tough times ahead.",
        "date": "2024-06-12",
      },
      {
        "username": "LogisticsPro",
        "comment": "Finding alternative suppliers is key, but the political landscape makes it incredibly challenging right now.",
        "date": "2024-06-12",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Dr. Anna Lopez",
      "bio": "Dr. Anna Lopez is a psychologist and mindfulness expert specializing in the benefits of meditation and mental health.",
    },
    "comments": [
      {
        "username": "ZenMaster",
        "comment": "Meditation has changed my life. It’s amazing to see the science catching up with what practitioners have known for centuries.",
        "date": "2024-06-13",
      },
      {
        "username": "MindfulLiving",
        "comment": "Incorporating mindfulness into schools and workplaces could be a game changer for mental health.",
        "date": "2024-06-13",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Emma Thompson",
      "bio": "Emma Thompson is an environmental journalist and policy advisor, specializing in climate change and sustainability initiatives.",
    },
    "comments": [
      {
        "username": "EcoWarrior",
        "comment": "Finally, some real progress! Now we need to ensure these promises are kept.",
        "date": "2024-06-14",
      },
      {
        "username": "ClimateActivist",
        "comment": "Great to see world leaders committing to change, but we need to act faster to avoid irreversible damage.",
        "date": "2024-06-14",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Kevin Roberts",
      "bio": "Kevin Roberts is a technology writer with a focus on automotive innovation, specializing in electric vehicles and battery technologies.",
    },
    "comments": [
      {
        "username": "EVFan",
        "comment": "This could be the breakthrough we’ve been waiting for. Can’t wait to see these batteries in the next generation of cars!",
        "date": "2024-06-15",
      },
      {
        "username": "GreenDriver",
        "comment": "Improved range and faster charging are key to making EVs the standard. This is exciting news!",
        "date": "2024-06-15",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Linda Carter",
      "bio": "Linda Carter is a real estate journalist who covers housing markets, affordability issues, and urban development trends.",
    },
    "comments": [
      {
        "username": "FirstTimeBuyer",
        "comment": "It’s frustrating to see housing prices keep rising. How are we supposed to afford our first home?",
        "date": "2024-06-16",
      },
      {
        "username": "PropertyWatcher",
        "comment": "We need more affordable housing, especially in cities. The market is leaving too many people behind.",
        "date": "2024-06-16",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Dr. Jason Lee",
      "bio": "Dr. Jason Lee is a chemist and environmental researcher focused on sustainable technologies and waste reduction methods.",
    },
    "comments": [
      {
        "username": "EcoInnovator",
        "comment": "This could be a game changer for plastic waste management. We need more breakthroughs like this!",
        "date": "2024-06-17",
      },
      {
        "username": "OceanSaver",
        "comment": "Anything that keeps plastics out of the ocean is a win in my book. Let’s hope this technology gets adopted soon.",
        "date": "2024-06-17",
      },
    ],
  },
  {
    ...
    "author": {
      ...
      "bio": "Dr. Samantha Miller is a healthcare technology expert and writer focusing on the impact of AI and innovation in the medical field.",
    },
    "comments": [
      {
        "username": "HealthTechGuru",
        "comment": "AI in healthcare is the future. It’s exciting to see how it can help doctors and patients alike.",
        "date": "2024-06-18",
      },
      {
        "username": "PrivacyFirst",
        "comment": "We need to make sure that patient data is handled responsibly as AI becomes more prevalent in healthcare.",
        "date": "2024-06-18",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Sarah Nelson",
      "bio": "Sarah Nelson is a travel and tourism expert who covers the economic impact of global travel trends and sustainable tourism practices.",
    },
    "comments": [
      {
        "username": "Globetrotter",
        "comment": "It’s great to see tourism bouncing back, but we need to be mindful of how it affects local communities and ecosystems.",
        "date": "2024-06-19",
      },
      {
        "username": "EcoTraveler",
        "comment": "As much as I love traveling, I hope we can focus more on sustainable tourism moving forward.",
        "date": "2024-06-19",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Jessica Lee",
      "bio": "Jessica Lee is an education technology specialist and journalist who writes about the future of learning and the role of emerging technologies in education.",
    },
    "comments": [
      {
        "username": "TechTeacher",
        "comment": "VR has the potential to revolutionize how we teach and learn. Exciting times for education!",
        "date": "2024-06-20",
      },
      {
        "username": "ClassroomInnovator",
        "comment": "The challenge will be making sure all students have access to this technology, regardless of their background.",
        "date": "2024-06-20",
      },
    ],
  },
  {
    ...
    "author": {
      ...
      "bio": "Michael Sanchez is a financial analyst and journalist specializing in cryptocurrency, blockchain, and fintech innovations.",
    },
    "comments": [
      {
        "username": "CryptoHawk",
        "comment": "Regulation is necessary, but I hope it doesn’t stifle innovation in the blockchain space.",
        "date": "2024-06-21",
      },
      {
        "username": "InvestorX",
        "comment": "We need clear regulations to protect investors. Too many scams out there right now.",
        "date": "2024-06-21",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Emily Johnson",
      "bio": "Emily Johnson is an automotive journalist and tech writer focusing on electric vehicles and the future of transportation.",
    },
    "comments": [
      {
        "username": "EVEnthusiast",
        "comment": "The future is electric! It’s about time we move away from fossil fuels.",
        "date": "2024-06-22",
      },
      {
        "username": "CarGuy",
        "comment": "Great to see more affordable options coming to market. I’m ready to go electric!",
        "date": "2024-06-22",
      },
    ],
  },
  {
    ...
    "author": {
      ...
      "bio": "Caroline Brooks is an economist and journalist covering global development, poverty, and food security issues.",
    },
    "comments": [
      {
        "username": "GlobalCitizen",
        "comment": "It’s heartbreaking to see hunger worsening despite so much global wealth. More needs to be done.",
        "date": "2024-06-23",
      },
      {
        "username": "FoodForAll",
        "comment": "The world has enough resources to feed everyone. It’s time for governments to act more decisively.",
        "date": "2024-06-23",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "David Green",
      "bio": "David Green is an environmental scientist and journalist specializing in renewable energy technologies and sustainability.",
    },
    "comments": [
      {
        "username": "GreenTechAdvocate",
        "comment": "Tidal and geothermal energy are such untapped resources. Great to see them getting more attention.",
        "date": "2024-06-24",
      },
      {
        "username": "EnergyInnovator",
        "comment": "These are promising developments. The more diverse our renewable energy sources, the better.",
        "date": "2024-06-24",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Dr. James Walters",
      "bio": "Dr. James Walters is a historian and AI specialist focused on the intersection of technology and historical research.",
    },
    "comments": [
      {
        "username": "HistoryBuff",
        "comment": "This is such a fascinating use of AI. We’re finally unlocking the secrets of ancient civilizations!",
        "date": "2024-06-25",
      },
      {
        "username": "TechForGood",
        "comment": "AI is transforming every field, even history. Imagine what else we’ll discover with this technology.",
        "date": "2024-06-25",
      },
    ],
  },
  {
    ...
    "author": {
      ...
      "bio": "Dr. Laura Bennett is a medical doctor and writer, specializing in digital health innovations and the future of healthcare delivery.",
    },
    "comments": [
      {
        "username": "TeleHealthFan",
        "comment": "Telemedicine has made it so much easier to get care without having to travel. A lifesaver in rural areas!",
        "date": "2024-06-26",
      },
      {
        "username": "PatientAdvocate",
        "comment": "While telemedicine is great, we need to ensure that privacy and quality care are prioritized.",
        "date": "2024-06-26",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Oliver Stevens",
      "bio": "Oliver Stevens is an economist and energy market analyst focusing on global commodity trends and their impact on economies.",
    },
    "comments": [
      {
        "username": "EnergyWatcher",
        "comment": "Rising oil prices always seem to have a ripple effect. Time to seriously invest in alternative energy sources.",
        "date": "2024-06-27",
      },
      {
        "username": "ConcernedConsumer",
        "comment": "Higher oil prices are already hitting my wallet. Hope we see some relief soon!",
        "date": "2024-06-27",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Rebecca Lee",
      "bio": "Rebecca Lee is a technology journalist and ethics researcher, specializing in the social implications of AI and emerging technologies.",
    },
    "comments": [
      {
        "username": "TechEthicsPro",
        "comment": "It’s about time we establish clear ethical guidelines for AI. This is a good step in the right direction.",
        "date": "2024-06-03",
      },
      {
        "username": "AIWatcher",
        "comment": "With AI advancing so fast, we need these standards to ensure it’s used responsibly.",
        "date": "2024-06-03",
      },
    ],
  },
  {
    ...
    "author": {
      ...
      "bio": "Sophie Martinez is an environmental policy expert and journalist covering climate change, sustainability, and global environmental summits.",
    },
    "comments": [
      {
        "username": "EcoWarrior",
        "comment": "It’s great to see climate change being taken seriously, but actions need to follow these promises!",
        "date": "2024-06-04",
      },
      {
        "username": "GreenEnergyFan",
        "comment": "Renewable energy is key. Let’s hope this summit results in real change and not just words.",
        "date": "2024-06-04",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Dr. Karen Blake",
      "bio": "Dr. Karen Blake is an oncologist and researcher specializing in innovative cancer treatments and medical breakthroughs.",
    },
    "comments": [
      {
        "username": "CancerFighter",
        "comment": "This is incredible news! Every breakthrough gives us more hope for a cure.",
        "date": "2024-06-05",
      },
      {
        "username": "HopefulSurvivor",
        "comment": "I’ve been following cancer research for years, and this is one of the most promising developments yet.",
        "date": "2024-06-05",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "David Peterson",
      "bio": "David Peterson is a financial analyst and journalist specializing in global markets, investment strategies, and economic trends.",
    },
    "comments": [
      {
        "username": "MarketWatcher",
        "comment": "It’s good to see some recovery, but there’s still a lot of uncertainty ahead.",
        "date": "2024-06-06",
      },
      {
        "username": "InvestorJoe",
        "comment": "This is a relief for those of us who’ve been watching our investments closely. Let’s hope this momentum continues.",
        "date": "2024-06-06",
      },
    ],
  },
  {
    ...
    "author": {
      "name": "Dr. Alan Reid",
      "bio": "Dr. Alan Reid is a physicist and quantum computing expert focused on the development of next-generation computational technologies.",
    },
    "comments": [
      {
        "username": "QuantumFan",
        "comment": "Quantum computing is the future. It’s exciting to see how close we are to practical applications.",
        "date": "2024-06-07",
      },
      {
        "username": "TechInnovator",
        "comment": "The potential for quantum computing is incredible. It’s going to change industries in ways we can’t even predict yet.",
        "date": "2024-06-07",
      },
    ],
  },
